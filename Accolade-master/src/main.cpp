...
const string strMessageMagic = "Accolade Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 394200; //394200 block will execute with in  12 months
...
static int64_t nTargetTimespan = 25 * 60;  // 25m
