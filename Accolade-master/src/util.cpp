...
int nAnonymizeAccoladeAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Accolade
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Accolade
    // Mac: ~/Library/Application Support/Accolade
    // Unix: ~/.Accolade
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Accolade";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Accolade.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Accoladed.pid"));
