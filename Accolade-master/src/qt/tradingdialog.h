...
private slots:
    ...
    QString BuyACCO(QString OrderType, double Quantity, double Rate);
    QString SellACCO(QString OrderType, double Quantity, double Rate);
